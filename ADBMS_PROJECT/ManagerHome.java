...
public class ManagerHome extends JFrame implements ActionListener
{
	...
	public ManagerHome(String userId)
	{
		...
		String items[] = new String[]{"select here","Sell Ticket","Add Employee","View Employee","Add Movie","Delete Movie","Change password","My Info"};
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		if(text.equals(goBtn.getText()))
		{
			...
			else if(comboText.equals("Add Employee"))
			{
