...
public class Customer  extends JFrame implements ActionListener
{
	...
	public Customer(String userId)
	{
		...
		String items[] = new String[]{"select here","My Tickets","Change password","My Info","Delete Account"};
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		if(text.equals(goBtn.getText()))
		{
			...
			if (comboText.equals("Change password"))
			{
				CChangePassword cp=new CChangePassword(userId);
				cp.setVisible(true);
			...
			{
				CInfo ci=new CInfo(userId);
				ci.setVisible(true);
				this.setVisible(false);
			
			}
			else if (comboText.equals("My Tickets"))
			{
				MyTicket mt=new MyTicket(userId);
				mt.setVisible(true);
				this.setVisible(false);
